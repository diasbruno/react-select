...
const Select = React.createClass({
	...
	renderClear () {
		if (this.props.clearable == NEVER_SHOW_CLEAN || this.props.clearable == SHOW_CLEAN && (!this.props.value || this.props.value === 0) || (this.props.multi && !this.props.value.length) || this.props.disabled || this.props.isLoading) return;
