...
var NEVER_SHOW_CLEAN = 0;
exports.NEVER_SHOW_CLEAN = NEVER_SHOW_CLEAN;
var SHOW_CLEAN = 1;
exports.SHOW_CLEAN = SHOW_CLEAN;
var ALWAYS_SHOW_CLEAN = 2;

exports.ALWAYS_SHOW_CLEAN = ALWAYS_SHOW_CLEAN;
var Select = _react2['default'].createClass({
        ...
        propTypes: {
                ...
                clearable: _react2['default'].PropTypes.number, // should it be possible to reset value
                ...
                id: _react2['default'].PropTypes.string, // optional attribute
        ...
        renderClear: function renderClear() {
                ...
                if (this.props.clearable <= SHOW_CLEAN && (!this.props.value || this.props.value === 0) || this.props.multi && !this.props.value.length || this.props.disabled || this.props.isLoading) return;
